...
%%
% ES SOM FØRSTE KORT
% Hypotese: Chancen for at trække et es er 4/52
% Ved X permutationer, vil antallet af es'er trukket først være X * (4/52)
hypotese = 4 / 52;
...
%%
% ES SOM FØRSTE KORT - BLACKJACK PÅ 2. KORT
% Hypotese, chancen for at trække et es er 4/52
% Hypotese, chancen for at trække blackjack på 2. kort er 16/51
% Chancen for at få blackjack efter at have trukket et es = (4/52) *
% (16/51)
P_es = 4/52;
P_ti = 16/51;
P_bj = P_es * P_ti;
...
%%
P_1 = 4/52; % Chance for at trække es først
P_2 = 16/51; % Chance for at trække 10 efter at have trukket es først
P_3 = 16/52; % Chance for at trække 10 først
P_4 = 4/51; % Chance for at trække es efter at have trukket 10 først
P_bj = P_1 * P_2;
P_bj2 = P_3 * P_4;
...
%%
% Strategi : Es = 1
% Træk 3 kort, check om samlet værdi er over 21
bust_count = 0;
for n=0:permutations
   cards = shufflecards();
   sum = 0;
